...
Once a business owner connects their GBP profile, the **very first thing
...
question first: **does this get us closer to that loop working
end-to-end, or is it scope creep before the core loop is proven?** Phases
2, 5, 6, and 7 below are explicitly secondary until this is demonstrated
working for at least one real connected business.
