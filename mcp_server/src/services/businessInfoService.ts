...
export class BusinessInfoService {
    ...
    async getLocation(locationName: string, readMask?: string) {
        ...
        return this.apiClient.get(locId, locationName, readMask ? { readMask } : undefined, GOOGLE_API.HOSTS.BUSINESS_INFO);
    }
    ...
    async updateLocation(locationName: string, body: any, updateMask: string) {
        ...
        const locId = extractLocationId(locationName);
        return this.apiClient.patch(locId, locationName, body, { updateMask }, GOOGLE_API.HOSTS.BUSINESS_INFO);
    }
    ...
    async getAttributes(locationName: string) {
        ...
        const locId = extractLocationId(locationName);
        return this.apiClient.get(locId, `${locationName}/attributes`, undefined, GOOGLE_API.HOSTS.BUSINESS_INFO);
    }
    ...
    async setAttributes(locationName: string, attributes: any[]) {
        ...
        const locId = extractLocationId(locationName);
        return this.apiClient.patch(locId, `${locationName}/attributes`, { attributes }, { updateMask: 'attributes' }, GOOGLE_API.HOSTS.BUSINESS_INFO);
    }
    ...
    async verifications(locationName: string) {
        ...
        const locId = extractLocationId(locationName);
        return this.apiClient.get(locId, `${locationName}/verifications`, undefined, GOOGLE_API.HOSTS.VERIFICATIONS);
    }
